...
COLOL_PALETTE = [color for color in COLOL_PALETTE if color != '#778AAE']  # Pourquoi on enleve cette couleur ?
...
COL_STYLESHEET = [
    {'selector': f'[liste_secteurs *= "{secteur}"]', 'style': {'background-color': f'{couleur}'}}
